...
interface MappingResultStatic {

	readonly class:any;
	new( arg0:any /*java.lang.Object*/ ):pintomau.graal_article.typescript_bundling.MappingResult;
}

export const MappingResult: MappingResultStatic = Java.type("pintomau.graal_article.typescript_bundling.MappingResult");
